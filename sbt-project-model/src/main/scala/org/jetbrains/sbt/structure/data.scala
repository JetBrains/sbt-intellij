...
case class ProjectData(id: String,
                       ...
                       configurations: Seq[ConfigurationData] = Seq.empty,
                       java: Option[JavaData] = None,
                       scala: Option[ScalaData] = None,
                       android: Option[AndroidData] = None,
                       dependencies: DependencyData = DependencyData(),
                       resolvers: Set[ResolverData] = Set.empty,
                       play2: Option[Play2Data] = None)

/**
 * Information about build dependencies and implicit imports for proper editing of .sbt files
 */
case class BuildData(imports: Seq[String] = Seq.empty,
                     classes: Seq[File] = Seq.empty,
                     docs: Seq[File] = Seq.empty,
...
case class DependencyData(projects: Seq[ProjectDependencyData] = Seq.empty,
                          modules: Seq[ModuleDependencyData] = Seq.empty,
                          jars: Seq[JarDependencyData] = Seq.empty)
